...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        PluginSettings.ContainsValue(true);
        PluginSettings.ContainsKey(true);
		...
		Thumbnails.MaxWidth = 354;
		Thumbnails.MaxHeight = 354;
		Thumbnails.Quality = 90;

        // Thumbnail 750px
        //Thumbnails.Url = BaseUrl + "_thumbs750/";
        //if (BaseDir != "")
        //{
        //    Thumbnails.Dir = BaseDir + "_thumbs750/";
        //}
        //Thumbnails.Enabled = true;
        //Thumbnails.DirectAccess = false;
        //Thumbnails.MaxWidth = 750;
        //Thumbnails.MaxHeight = 750;
        //Thumbnails.Quality = 80;

        // Thumbnail 239px
        //Thumbnails.Url = BaseUrl + "_thumbs239/";
        //if (BaseDir != "")
        //{
        //    Thumbnails.Dir = BaseDir + "_thumbs239/";
        //}
        //Thumbnails.Enabled = true;
        //Thumbnails.DirectAccess = false;
        //Thumbnails.MaxWidth = 239;
        //Thumbnails.MaxHeight = 239;
        //Thumbnails.Quality = 80;
        
        // Thumbnail 165px
        //Thumbnails.Url = BaseUrl + "_thumbs165/";
        //if (BaseDir != "")
        //{
        //    Thumbnails.Dir = BaseDir + "_thumbs165/";
        //}
        //Thumbnails.Enabled = true;
        //Thumbnails.DirectAccess = false;
        //Thumbnails.MaxWidth = 165;
        //Thumbnails.MaxHeight = 165;
        //Thumbnails.Quality = 80;
        ...
        //type = ResourceType.Add("Images165");
        //type.Url = BaseUrl + "_thumbs165/";
        //type.Dir = BaseDir == "" ? "" : BaseDir + "_thumbs165/";
        //type.MaxSize = 750;
        //type.AllowedExtensions = new string[] { "bmp", "gif", "jpeg", "jpg", "png" };
        //type.DeniedExtensions = new string[] { };
